    ...
    <div className='about-wrap'>
      ...
      <div className="about-txt" ref={aboutTxtRef}>
        <h2>
          ...
          <p>
          대학 졸업 후 CCC라는 선교단체에서 5년간 전임 간사로 사역하며 사람들을 만나고 가르치는 일을 했습니다. 30대가 되면서 '새로운 일을 할 수 있는 마지막 기회가 있다면, 지금이 아닐까?'라는 생각이 들었고, UI/UX 디자인 과정을 수료하여 웹 디자이너로 전향하게 되었습니다.<br/>저는 한 기업에 소속되어 애정을 가지고 오랫동안 일하고 싶습니다. 사람을 배려하며 관계를 쌓고, 업무를 통해 성장하며 기업과 함께 웃는 디자이너가 되겠습니다!
          </p>
        </div>
      </div>
      {showAboutPlus &&
